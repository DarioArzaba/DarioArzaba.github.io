...
title: Lynx
---
Navegador en texto para Windows que muestra los sitios web sin la interfaz del usuario (GUI). No muestra ningun tipo de imagenes, scripts o graficos y por lo tanto es exepcionalmente rapido. Desarrollada originalmente por Lou Montulli, Michael Grobe y Charles Rezac en la Universidad de Kansas (1992), mantenido actualmente por Thomas Dickey. Se puede utilizar para determinar problemas de Crowling en un sitio Web. Una de las principales razones por las que se continuo su desarrollo fue como un navegador accesible que pudiera leer el texto de la pantalla y trabajar con [Refreshable Braille Displays](https://es.wikipedia.org/wiki/Dispositivo_Braille).
